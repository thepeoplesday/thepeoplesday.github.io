...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="./tpd.png" />
  <link rel="shortcut icon" href="./tpd.png" type="image/png" />
     ...
     <div class="container">
      ...
      <div class="navbar-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="#awards" title="" class="anchor-link">awards</a></li>
          <li><a href="#gallery" title="" class="anchor-link">gallery</a></li>
...
<br>
            ...
            <div class="col-xs-12 col-md-4">
                ...
                <p class="text-center">The People’s Day is <b>free</b> and open to everyone!</p>
            </div>
            <div class="col-xs-12 col-md-4">
                <div class="fa-container">
                ...
                <p class="text-center"> You will be able to follow “The People’s Day” live streaming from our <a href="https://www.facebook.com/EastHarlemLive/">Facebook Page</a></p>
            </div>
            <div class="col-xs-12 col-md-4">
                <div class="fa-container">
                ...
                <p class="text-center">See you at The People’s Day<br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-6 text-column">
                ...
                <p>The People’s Day is part of a social engagement art project called East Harlem Live co-founded by the 111! Collective and members of the East Harlem Community.</p>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 section-container-spacer">
                ...
                <div class="col-xs-12 col-md-6">
                  ...
                  <div class="col-xs-12 col-md-12">
                          <h3 class="text-center">¡Que Rico! (FOOD)</h3>
                            <p class="text-center">Tamales Lupita<br>Cafe Ollin</p>
                    </div>


                <div class="col-xs-12 col-md-6">
                  <img src="./images/awardees/IMG_8301.JPG" class="img-responsive">
                </div>
                <div class="col-xs-12 col-md-6">
                  <img src="./images/awardees/IMG_8357.JPG" class="img-responsive">
                </div>
                  <div class="col-xs-12 col-md-12">
                          <h3 class="text-center">Staying Alive (HEALTH)</h3>
                            <p class="text-center">Sanduga Dance Studio<br>Dr...</p>
                    </div>

                <div class="col-xs-12 col-md-6">
                  <img src="./images/awardees/IMG_8377.JPG" class="img-responsive">
                          <h3 class="text-center">No Nos Moveran</h3>
                          <p class="text-center">Joe Encarnacion</p>
                    </div>


                <div class="col-xs-12 col-md-6">
                  <img src="./images/awardees/elmuseo.jpg" class="img-responsive">
                          <h3 class="text-center">Knowledge is Power (EDUCATION)</h3>
                            <p class="text-center">El Museo Del Barrio</p>
                    </div>

                    <div class="col-xs-12 col-md-6">
                        <img src="./images/awardees/IMG_8346.JPG" class="img-responsive">
                              <h3 class="text-center">Lifetime Achievement</h3>
                                <p class="text-center">Carlos "Carlitos" Banks</p>
                        </div>


                <div class="col-xs-12 col-md-6">
                  <img src="./images/awardees/IMG_8388.JPG" class="img-responsive">
                          <h3 class="text-center">Young Leaders (YOUTH)</h3>
                          <p class="text-center">Escuela de Mariachi Angeles de NY</p>
                    </div>


                    <div class="col-xs-12 col-md-6">
                      <img src="./images/awardees/IMG_8458.JPG" class="img-responsive">
                    </div>
                    <div class="col-xs-12 col-md-6">
                      <img src="./images/awardees/IMG_8461.JPG" class="img-responsive">
                    </div>
                      <div class="col-xs-12 col-md-12">
                              <h3 class="text-center">On the Good Foot (DANCE)</h3>
                                <p class="text-center">Soles of Duende<br>Kotchenga Dance Company</p>
                        </div>


                <div class="col-xs-12 col-md-4">
                          <h3 class="text-center">Last Night a DJ Saved My Life</h3>
                    </div>
      ...
      <div class="section-container" id="gallery">
        <div class="container">
            ...
            /* ========================================================================== */
                  ...
                  $qt_folder_name = './images/gallery/'; // change this to a folder of your choice for images
